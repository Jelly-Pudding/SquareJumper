...
def eval_genomes(genomes, config):
    ...
    while running == True:
        ...
        for i in range(len(list_of_all_connections)):
            ...
            # The layers for input and output nodes are not needed for the representation, so they get set to None
